...
Your Excel sheet should include at least the following columns:
gene_id	      start	  end	    scaffold	    strand
LOC111594728	6880699	6886873	NW_022045678	+
LOC111594728	6880787	6886873	NW_022045678	+
...
3. Open Terminal and ortient to the Gene_CDS_Range_Extractor using the cd Command:

cd /path/to/your/script

4. Create a virtual environment in Terminal: 
...
5. Install required library to open Excel files:
